...
if(isset($_POST['submit'])){
    ...
    // Collect post variables
        ...
        $owner_id = "S20180317105200";
          ...
          $sql = "INSERT INTO  `msg` (`msg`, `date_time`, `status`, `owner_id`) VALUES ('$message','$date','$status','$owner_id')";
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Add Messages</h6> 
                <?php
              ...
              <div class="table-responsive p-3">
                ...
                <form role="form" class="text-start" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    ...
                    <div class="row">
                          ...
                          <div class="col-sm-12 ">
                            <img src="working.webp" alt="" style="height: 400px; width: 100%; border-radius: 5px;">
                          </div>
                          
                          <div class="col-sm-12 "> <p class="text-danger text-bold text-center rounded py-2 bg-light " > ADD NEW MESSAGES </p> </div>
                          
                          <div class="col-sm-9 ">
                              <label ><span class="text-danger text-bold">* </span> Message </label>
                              <textarea name="message" Placeholder="Enter Message" class="fs" required="required" > </textarea>
                            
                          </div>
                          
                          <!--<div class="col-sm-6 ">
                              <label ><span class="text-danger text-bold">* </span> Owner ID</label>
                            <input type="text" name="f_code" Placeholder="Enter Owner ID" class="fs" required >
                          </div>-->
                          
                          <div class="col-sm-3 ">
                              <label ><span class="text-danger text-bold">* </span> ADD Date and Time </label>
                            <input type="datetime-local" name="date" Placeholder="ADD Message Date Time" id="fsh" class="fs" required="required" >
                          </div>
