          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <?php
                    ...
                    $sql="SELECT slno FROM enquiry ORDER BY slno DESC LIMIT 1";
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Enquiry</h6>
              </div>
            </div>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                      ...
                      <?php
                          include '../db1.php';
                              $sql="SELECT slno,name,mail,cell FROM enquiry ORDER BY `enquiry`.`slno` DESC";
                    ...
                    <tr>
                      ...
                      <td> <a href="viewenquiry.php?id=<?php echo $res['slno']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
