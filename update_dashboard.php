...
<?php
    ...
    if(isset($_POST['uid'])) {
        mysqli_query($con,"UPDATE users set uid='" . $_POST['uid'] . "', logid='" . $_POST['logid'] . "', logpwd='" . $_POST['logpwd'] . "', name='" . $_POST['name'] . "' ,fname='" . $_POST['fname'] . "', mname='" . $_POST['mname'] . "', cell='" . $_POST['cell'] . "', mail='" . $_POST['mail'] . "', dob='" . $_POST['dob'] . "', gender='" . $_POST['gender'] . "', qual='" . $_POST['qual'] . "', address='" . $_POST['address'] . "', city='" . $_POST['city'] . "', sub_district='" . $_POST['sub_district'] . "', district='" . $_POST['district'] . "', state='" . $_POST['state'] . "', country='" . $_POST['country'] . "', postal_code='" . $_POST['postal_code'] . "', user_type='" . $_POST['user_type'] . "' WHERE u_no='" . $id . "'");

        $message = "Record Modified Successfully";
        
        header("Location: viewdashboard.php?id=$id&mess=true");
    }
            ...
            <div class="card-header p-3 pt-2">
              <div class="icon icon-lg icon-shape bg-gradient-primary shadow-primary text-center border-radius-xl mt-n4 position-absolute">
                <i class="material-icons opacity-10">person</i>
                            ...
                            <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">Today's Course</p>
                <h4 class="mb-0"> 1 </h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
              ...
              <div class="table-responsive p-3">
                ...
                <form role="form" class="text-start" method="POST" action="">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 ">
                          <label ><span style="color:red;font-weight: bold;">* </span> User Id</label>
                        <input type="text" name="uid" value="<?php echo $res['uid'];  ?> "readonly class="fs" >   
                      </div>
                    
                      <div class="col-sm-6 ">
                          <label ><span style="color:red;font-weight: bold;">* </span> Login ID</label>
                        <input type="text" name="logid" value="<?php echo $res['logid'];  ?>" class="fs" >
                      </div>
                      
                      <div class="col-sm-6 ">
                          <label ><span style="color:red;font-weight: bold;">* </span> Login Password</label>
                        <input type="text" name="logpwd" value="<?php echo $res['logpwd'];  ?>" class="fs" >
                      </div>
                      
                      <div class="col-sm-6 ">
                          <label ><span style="color:red;font-weight: bold;">* </span> Name</label>
                        <input type="text" name="name" value="<?php echo $res['name'];  ?>" class="fs" >
                      </div>
                      
                      <div class="col-sm-6 ">
                          <label ><span style="color:red;font-weight: bold;">* </span> Father Name</label>
                        <input type="text" name="fname" value="<?php echo $res['fname'];  ?>" class="fs" >
                      </div>
                    
                      <div class="col-sm-6 ">
                          <label ><span style="color:red;font-weight: bold;">* </span> Mother Name</label>
                        <input type="text" name="mname" value="<?php echo $res['mname'];  ?>" class="fs" ">
                      </div>
                      
                      <div class="col-sm-6 ">
                          <label ><span style="color:red;font-weight: bold;">* </span> Phone</label>
                        <input type="number" name="cell" value="<?php echo $res['cell'];  ?>" class="fs" ">
                      </div>
                    
                      <div class="col-sm-6 ">
                          <label ><span style="color:red;font-weight: bold;">* </span> Mail</label>
                        <input type="text" name="mail" value="<?php echo $res['mail'];  ?>" class="fs" >
                      </div>
                      ...
                      <div class="col-sm-6 ">
                          <label ><span style="color:red;font-weight: bold;">* </span> Qualification </label>
                        <input type="text" name="qual" value="<?php echo $res['qual'];  ?>" class="fs" >
                      </div>
                      
                      <div class="col-sm-6 ">
                          <label ><span style="color:red;font-weight: bold;">* </span> Address</label>
                        <input type="text" name="address" value="<?php echo $res['address'];  ?>" class="fs" >
                      </div>
                      
                      <div class="col-sm-6 ">
                          <label ><span style="color:red;font-weight: bold;">* </span> City</label>
                        <input type="text" name="city" value="<?php echo $res['city'];  ?>" class="fs" >
                      </div>
                      
                      <div class="col-sm-6 ">
                          <label ><span style="color:red;font-weight: bold;">* </span> Sub District</label>
                        <input type="text" name="sub_district" value="<?php echo $res['sub_district'];  ?>" class="fs" >
                      </div>
                      
                      <div class="col-sm-6 ">
                          <label ><span style="color:red;font-weight: bold;">* </span> District</label>
                        <input type="text" name="district" value="<?php echo $res['district'];  ?>" class="fs" >
                      </div>
                      
                      <div class="col-sm-6 ">
                          <label ><span style="color:red;font-weight: bold;">* </span> State</label>
                      ...
                      <div class="col-sm-6 ">
                          <label ><span style="color:red;font-weight: bold;">* </span> Country</label>
                        <input type="text" name="country" value="<?php echo $res['country'];  ?>" class="fs" >
                      </div>
                      
                      <div class="col-sm-6 ">
                          <label ><span style="color:red;font-weight: bold;">* </span> Postal Code</label>
                        <input type="text" name="postal_code" value="<?php echo $res['postal_code'];  ?>"readonly class="fs" >
                      </div>
                      
                      <div class="col-sm-6 ">
                          <label ><span style="color:red;font-weight: bold;">* </span> User Type</label>
                        <input type="text" name="user_type" value="<?php echo $res['user_type'];  ?>" class="fs" >
                      </div>
                      
                      <div class="col-sm-6 ">
                           <label ><span style="color:red;font-weight: bold;">* </span> Owner ID</label>
                        <input type="text" name="owner_id" value="<?php echo $res['owner_id'];  ?>" class="fs" >
                      </div>
