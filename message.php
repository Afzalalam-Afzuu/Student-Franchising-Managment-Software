          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <?php
                    ...
                    $sql="SELECT slno FROM msg ORDER BY slno DESC LIMIT 1";
            ...
            <div class="col-md-12 mb-lg-0 mb-4">
              <div class="card mt-4">
                <div class="card-header pb-0 p-3">
                  <div class="row">
                    ...
                    <div class="col-6 text-end">
                      <a class="btn bg-gradient-dark mb-0" href="add_messages.php"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Add New Messages</a>
                    </div>
                  </div>
                </div>
                <div class="card-body p-2 text-center">
                    <?php
                        if($insert == 1){
                        echo "<h5 style='color: red; font-weight: bold; margin-top: 5px; '>Add new Messages successfully. </h5>";
                        }
                    ?>
                </div>
              </div>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                      ...
                      <?php   
                          include '../db1.php';
                              $sql="SELECT slno,msg,status,date_time FROM msg ORDER BY `msg`.`slno` DESC";
                    ...
                    <tr>
                      ...
                      <td> <a href="viewmessage.php?id=<?php echo $res['slno']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
