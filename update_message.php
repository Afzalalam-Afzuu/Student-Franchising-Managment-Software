...
<?php
    ...
    if(isset($_POST['submit'])) {
        mysqli_query($con,"UPDATE msg set msg='" . $_POST['message'] . "', date_time='" . $_POST['date'] . "', status='" . $_POST['status'] . "' WHERE slno='" . $id . "'");

        #$message = "Record Modified Successfully";
        
        header("Location: viewmessage.php?id=$id&mess=true");
              ...
              <div class="table-responsive p-3">
                ...
                <form role="form" class="text-start" method="POST" action="">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 ">
                        <label><span class="text-danger text-bold">* </span> Message </label>
                        <textarea type="text" name="message" value="<?php echo $res['msg'];  ?>" class="fs" > 
                            <?php echo $res['msg'];  ?>
                        </textarea>
                      </div>
                      
                      <div class="col-sm-6 ">
                        <label ><span style="color:red;font-weight: bold;">* </span> Message Date Time </label>
                        <input type="text" name="date" value="<?php echo $res['date_time'];  ?>" class="fs" >
                      </div>
                    
                      <div class="col-sm-6 ">
                        <label ><span style="color:red;font-weight: bold;">* </span> Message Status </label>
                        <input type="text" name="status" value="<?php echo $res['status'];  ?>" class="fs" >
                      </div>
