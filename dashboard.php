            ...
            <div class="card-header p-3 pt-2">
              <div class="icon icon-lg icon-shape bg-gradient-primary shadow-primary text-center border-radius-xl mt-n4 position-absolute">
                ...
                <?php
                    ...
                    $sql="SELECT u_no FROM users ORDER BY u_no DESC LIMIT 1";
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                      ...
                      <?php
                          include '../db1.php';
                              $sql="SELECT u_no,uid,name,fname,mail,logpwd FROM users ORDER BY `users`.`u_no` DESC";  
                    ...
                    <tr>
                      ...
                      <td> <?php echo $res['logpwd'];  ?> </td>
                      <td> <a href="viewdashboard.php?id=<?php echo $res['u_no']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
