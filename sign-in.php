...
if (isset($_POST['submit'])) {
    ...
    $query    = "SELECT * FROM user WHERE userid='$username'   AND password='" .SHA1($password)."'";
        ...
        <nav class="navbar navbar-expand-lg blur border-radius-xl top-0 z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
          <div class="container-fluid ps-2 pe-0">
            <ul class="navbar-nav d-lg-block d-none">
                <li class="nav-item">
                  <a href="javascript:void(0)" class="btn btn-sm mb-0 me-1 bg-gradient-dark">Ashoka India</a>
                </li>
              </ul>
              ...
              <div class="card-body">
                <form role="form" class="text-start" method="POST" action="">
                  ...
                  <div class="text-center">
                    <button type="submit" value="Login" name="submit" class="btn bg-gradient-primary w-100 my-4 mb-2" >Sign in</button>
                  </div>
                  <?php if($msg == true){  
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-12 col-md-6 my-auto">
              <div class="copyright text-center text-sm text-white text-lg-start">
                ...
                Powered by
                <a href="https://www.microcen.com" class="font-weight-bold text-white" target="_blank">Microcen</a>
